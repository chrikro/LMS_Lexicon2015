namespace LMS_Lexicon2015.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<LMS_Lexicon2015.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(LMS_Lexicon2015.Models.ApplicationDbContext context)
        {
            ...
            var courses = new[] {
                new CourseOccasion { Name = "csharp", Description = "Text text text text", StartDate = new DateTime(2015, 03, 11,09,00,00), EndDate = new DateTime(2015, 03, 16,16,30,00), GroupId = groups[0].Id  },
                new CourseOccasion { Name = "Angular JS", Description = "Text text text text", StartDate = new DateTime(2015, 04, 27,09,00,00), EndDate = new DateTime(2015, 05, 10,16,30,00), GroupId = groups[0].Id  },
                new CourseOccasion { Name = "SQL", Description = "Språk för att manipulera data i en databas.", StartDate = new DateTime(2015, 08, 31,09,00,00), EndDate = new DateTime(2015, 09, 05,16,30,00), GroupId = groups[1].Id  },
            ...
            createNewDocument(context, groups[1].Id,null,null, "nisaw99@hotmail.com", "ReadMe.txt", "Ett nytt fint dokument som handlar om något.", new DateTime(2015, 09, 01,10,30,00));
            createNewDocument(context, groups[1].Id, courses[2].Id, null, "jultomten@nordpoolen.org", "csharp_extra.txt", "Ett nytt fint dokument som handlar om C#.", new DateTime(2015, 09, 02,14,00,00));
            createNewDocument(context, groups[1].Id, courses[2].Id, activitys[0].Id, "jultomten@nordpoolen.org", "test.txt", "Ett nytt fint dokument som handlar om SQL.", new DateTime(2015, 09, 03,09,30,00));
        }
